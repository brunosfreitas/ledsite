...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<meta name="keywords" content="laboratório de educação a distância; laboratório; videoaulas; videoconferência; EaD; gravações; gravação; vídeo; edição de vídeo; programação; design; websdesign; captura de imagem; edição de audio" />
	<meta name="author" content="LED/UFSC" />
  ...
  <!-- Facebook and Twitter integration -->
                    ...
                    <nav class="navbar navbar-default">
                        <div class="col-md-2">
                            <div class="navbar-header">
                                ...
                                <a class="navbar-brand" href="index.html"><img src="images/logo-ledlab-roxo.png" class="img-responsive" height="72px" width="72px" alt="Free HTML5 Template"></a>
                            </div>
                        </div>
                        <div class="col-md-10">
                            <div id="navbar" class="navbar-collapse collapse">
                              <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="#" data-nav-section="sobre"><span>Sobre</span></a></li>
	...
	<div id="slider" data-section="home">
		<div class="owl-carousel owl-carousel-fullwidth">
            ...
            <!--<div class="item" style="background-image:url(images/banner-ledlab-11.png)">-->
            ...
            <div class="item" style="background-image:url(images/banner-ledlab-1-fundo.png)">
                <div class="overlay"></div>
                <div class="container-fluid slider-container-fluid" style="position: relative;">
                    <div class="row">
                        <div class="col-md-12 vcenter">
                            <img class="vcenter" src="images/banner-ledlab-1-cut.png" alt="Free HTML5 Template by FREEHTML5.co">
                        </div>
                    </div>
                </div>
            </div>
			<!-- You may change the background color here.  -->
            <div class="item" style="background-image:url(images/banner-lampada.png)">
                <div class="container-fluid slider-container-fluid" style="position: relative;">
		    		<div class="row">
		    			<div class="col-md-12 vcenter">
        ...
        <div class="container">
            <div class="row " id="about-us">
                <div class="col-md-12 section-heading text-center">
					...
					<h2 class="to-animate"><img src="images/logo-ledlab-roxo-200-rede.png" class="img-responsive center-block" alt="LEDLAB logo"></h2>
				...
				<div class="col-md-4 to-animate">
                    ...
                    <p>A missão do <strong>LED</strong>LAB, segue a filosofia da UFSC e consiste em: promover a criação e disseminação do conhecimento entre a Universidade e os distintos segmentos da sociedade, independente da localização geográfica, utilizando ambientes virtuais de aprendizagem formados com a integração de referenciais pedagógicos consistentes e tecnologias de informação e comunicação de última geração.</p>
                    <p><a href="#" data-nav-section="equipe" class="btn btn-primary">Conheça a Equipe <strong>LED</strong>LAB</a></p>
				</div>
			</div>
		</div>
	</div>

    <div id="fh5co-features" data-section="servicos">
        <div class="container">
            <div class="row">
                <div class="col-md-12 section-heading text-center">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 single-animate animate-features-2">
                            <h3>Com uma equipe multidisciplinar, eficiente e experiente, o <strong>LED</strong>LAB oferece uma gama de serviços a comunidade universitária.<h3>
                        </div>
                    </div>
                </div>
            </div>
	...
	<div id="fh5co-press" data-section="portifolio">
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
				...
				<div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <p class="text-justify">Além de ser o aniversário de Einstein, várias instituições de ensino norte-americanas e empresas ligadas à tecnologia usam o 14 de Março (= 3.14 no formato americano de datas) para comemorar o Dia de Pi. Promovem gincanas, brincadeiras e vários tipos de eventos temáticos – de matemática à ciência da computação.
                                        <br>
                                        <a href="http://www.piacademy.com.br/" target="_blank" >http://www.piacademy.com.br/</a></p>

                                    <div class="embed-responsive embed-responsive-16by9">
                                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/6xcNyduPQLE"></iframe>
                                    </div>
                                </div>
                            </div>
						</div>
                    ...
                    <div class="fh5co-press-item to-animate">
                        <div class="fh5co-press-text-full">
                            <div class="row">
                                <div class="col-xs-10">
                                    <h3 class="h2 fh5co-press-title">EGC - Como conseguir o título de mestre<span class="fh5co-border"></span></h3>
                                </div>
                                <div class="col-xs-2 text-right">
                                    <span><i class="icon-film icon-portifolio"></i></span>
                                </div>
                                <div class="col-md-12">
                                    <p class="text-justify">O que preciso fazer para conseguir meu título de Mestre do EGC - UFSC

                                        Mais informações em <a href="egc.ufsc.br" target="_blank">egc.ufsc.br</a><br>
                                        <a href="http://www.piacademy.com.br/" target="_blank" >http://www.piacademy.com.br/</a></p>

                                    <div class="embed-responsive embed-responsive-16by9">
                                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/CxwNhSoAqlY"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="fh5co-press-item to-animate">
                        <div class="fh5co-press-text-full">
                            <div class="row">
                                <div class="col-xs-10">
                                    <h3 class="h2 fh5co-press-title">Programação - Inovímetro <span class="fh5co-border"></span></h3>
                                </div>
                                <div class="col-xs-2 text-right">
                                    <span><i class="icon-cup icon-portifolio"></i></span>
                                </div>
                                <div class="col-md-12">
                                    <p>Projeto em parceria com o <a href="http://www.ipdmaq.org.br/" target="_blank">IPDMAQ</a> (Instituto de Pesquisa e Desenvolvimento Tecnológico da Indústria de Máquinas e Equipamentos) foi desenvolvido um sistema de perguntas e respostas baseado num jogo de cartas. Ao final das perguntas um relatório com gráficos dinâmico era gerado para o usuário.<p>
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="fh5co-press-item to-animate">
                        <div class="fh5co-press-text-full">
                            <div class="row">
                                <div class="col-xs-10">
                                    <h3 class="h2 fh5co-press-title">V Conferência Estadual de CTI - Procedimentos Metodológicos<span class="fh5co-border"></span></h3>
                                </div>
                                <div class="col-xs-2 text-right">
                                    <span><i class="icon-camrecorder icon-portifolio"></i><i class="icon-film icon-portifolio"></i></span>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <div class="embed-responsive embed-responsive-16by9">
                                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/ndNeGybNIwo"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="fh5co-press-item to-animate">
                        <div class="fh5co-press-text-full">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="img-portifolio text-center">
                                        <a href="www.egc.ufsc.br" target="_blank">
	...
	<footer id="footer" role="contentinfo">
		<div class="container">
			<div class="row row-bottom-padded-sm">
				<div class="col-md-12">
					<p class="copyright text-center"><a href="www.led.ufsc.br"><strong>LED</strong>LAB</a> - <a href="www.egc.ufsc.br">EGC</a> - <a href="www.ufsc.br">UFSC</a></p>
